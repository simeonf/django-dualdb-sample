...
class Album(models.Model):
    album = models.IntegerField(primary_key=True, db_column=u'AlbumId') # Field name made lowercase.
    title = models.TextField(db_column=u'Title') # Field name made lowercase. This field type is a guess.
    artistid = models.ForeignKey("Artist", db_column=u'ArtistId', to_field="artistid") # Field name made lowercase.
